...
CREATE TABLE `da_nop` (
  ...
  PRIMARY KEY (`id`),
  KEY `da_nop_ibfk_1` (`idPhi`),
  KEY `da_nop_ibfk_2` (`idHoKhau`),
  CONSTRAINT `da_nop_ibfk_1` FOREIGN KEY (`idPhi`) REFERENCES `phi` (`id`),
  CONSTRAINT `da_nop_ibfk_2` FOREIGN KEY (`idHoKhau`) REFERENCES `ho_khau` (`id`)
...
INSERT INTO `da_nop` VALUES (1,1,1,50000,'2023-02-22 00:00:00'),(2,3,2,100000,'2023-02-22 00:00:00'),(3,1,4,50000,'2023-02-22 00:00:00');
